/*
Meter en el folder
"/usr/share/SuperCollider/SCClassLibrary/Common/GUI/"
*/

ServerMeterViewOpera{
...
ServerMeterOpera{
	...
	*new{ |server, numIns, numOuts|
		...
		window = Window.new(server.name ++ " levels (dBFS)",
							Rect(5, 305, ServerMeterViewOpera.getWidth(numIns,numOuts), ServerMeterViewOpera.height),
							false);

		meterView = ServerMeterViewOpera(server, window, 0@0, numIns, numOuts);
